...
import com.example.firebasetutor.databinding.ActivityBeginnerLegCoreD1W6Binding

class beginnerLegCoreD1W6 : AppCompatActivity() {

    private lateinit var binding: ActivityBeginnerLegCoreD1W6Binding
   ...
   // private lateinit var nextButton: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBeginnerLegCoreD1W6Binding.inflate(layoutInflater)
        setContentView(binding.root)

        workoutTV = binding.includedBeginnerLegCoreD1W6.workoutNameTV
        setValueText = binding.includedBeginnerLegCoreD1W6.setTV
        workoutAmountTV = binding.includedBeginnerLegCoreD1W6.workoutAmountTV
        ...
        Glide.with(this)
            ...
            .load(gif1)
            .fitCenter()
            .into(binding.includedBeginnerLegCoreD1W6.gifIV)


        initializeViews()


        val getWorkoutName = sharedPreferences.getString("workoutName6", "")
        val getRepCount = sharedPreferences.getString("repCount6", "")

        val a1 = binding.includedBeginnerLegCoreD1W6.workoutNameTV
        val a2 = binding.includedBeginnerLegCoreD1W6.workoutAmountTV
        ...
        if (isBeginnerSchedView == "Yes") {
            ...
            if (isWorkout == "LegCore") {
                ...
                when(beginnerLegCorePhase){
                    0, 1, 2, 3, 4, 5 ->{
                        when(workoutNumSet){
                            "15" -> gif1 = R.drawable.gif_lunges
                            "16" -> gif1 = R.drawable.gif_lunges
                            "17" -> gif1 = R.drawable.gif_lunges
            ...
            if (isWorkout == "LegCore") {
                ...
                when(intermediateLegCorePhase){
                    0, 1, 2, 3, 4, 5 ->{
                        when(workoutNumSet){
                            "15" -> gif1 = R.drawable.gif_single_leg_romanian_dead_lift
                            "16" -> gif1 = R.drawable.gif_single_leg_romanian_dead_lift
                            "17" -> gif1 = R.drawable.gif_single_leg_romanian_dead_lift
                        }
                    }
                }
    ...
    private fun initializeViews() {
        countdownTextView = binding.includedBeginnerLegCoreD1W6.timeCountdownTV
        workoutAmountTV = binding.includedBeginnerLegCoreD1W6.workoutAmountTV
        pauseButton = binding.includedBeginnerLegCoreD1W6.pauseBtnTV
        //nextButton = binding.includedBeginnerLegCoreD1W6.nextBtnTV
    ...
    private fun askPrefVisit(){
        ...
        if(workoutNumSet == "15"){
            editor = sharedPreferences.edit()
            editor.putString("Set", "16")
            editor.commit()
        }
        else if(workoutNumSet == "16"){
            editor = sharedPreferences.edit()
            editor.putString("Set", "17")
            editor.commit()

        }
        else if(workoutNumSet == "17"){
            editor = sharedPreferences.edit()
