...
import com.example.firebasetutor.databinding.ActivityAskDisease4Binding

private lateinit var binding: ActivityAskDisease4Binding
...
class AskDisease4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAskDisease4Binding.inflate(layoutInflater)
        ...
        diseaseBackBtn.setOnClickListener {
            ...
            editor.commit()
            val intentBack = Intent(this, AskDisease3::class.java)
        ...
        yesBtn.setOnClickListener {
            editor.putString("askDisease4","Yes")
            editor.commit()
        ...
        noBtn.setOnClickListener {
            ...
            editor.putString("askDisease4","No")
            editor.commit()
        ...
        nextBtnDisease.setOnClickListener {
            val askDisease = sharedPreferences.getString("askDisease4", "None") // Get the updated value

            when (askDisease) {
                "Yes", "No" -> {
                    val intent = Intent(this, AskDisease5::class.java)
