...
import com.example.firebasetutor.databinding.ActivityBeginnerLegCoreD1W3Binding

class beginnerLegCoreD1W3 : AppCompatActivity() {

    private lateinit var binding: ActivityBeginnerLegCoreD1W3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBeginnerLegCoreD1W3Binding.inflate(layoutInflater)
        setContentView(binding.root)

        workoutTV = binding.includedBeginnerLegCoreD1W3.workoutNameTV
        setValueText = binding.includedBeginnerLegCoreD1W3.setTV
        workoutAmountTV = binding.includedBeginnerLegCoreD1W3.workoutAmountTV
        ...
        Glide.with(this)
            ...
            .load(gif1)
            .fitCenter()
            .into(binding.includedBeginnerLegCoreD1W3.gifIV)


        initializeViews()


        val getWorkoutName = sharedPreferences.getString("workoutName3", "")
        val getRepCount = sharedPreferences.getString("repCount3", "")

        val a1 = binding.includedBeginnerLegCoreD1W3.workoutNameTV
        val a2 = binding.includedBeginnerLegCoreD1W3.workoutAmountTV
        ...
        if (isBeginnerSchedView == "Yes") {
            ...
            if (isWorkout == "LegCore") {
                ...
                when(beginnerLegCorePhase){
                    0, 1, 2, 3, 4, 5 ->{
                        when(workoutNumSet){
                            "6" -> gif1 = R.drawable.gif_russian_twist
                            "7" -> gif1 = R.drawable.gif_russian_twist
                            "8" -> gif1 = R.drawable.gif_russian_twist
            ...
            if (isWorkout == "LegCore") {
                ...
                when(beginnerLegCorePhase){
                    0, 1, 2, 3, 4, 5 ->{
                        when(workoutNumSet){
                            "6" -> gif1 = R.drawable.gif_hanging_leg_raise
                            "7" -> gif1 = R.drawable.gif_hanging_leg_raise
                            "8" -> gif1 = R.drawable.gif_hanging_leg_raise
    ...
    private fun initializeViews() {
        countdownTextView = binding.includedBeginnerLegCoreD1W3.timeCountdownTV
        workoutAmountTV = binding.includedBeginnerLegCoreD1W3.workoutAmountTV
        pauseButton = binding.includedBeginnerLegCoreD1W3.pauseBtnTV
        //nextButton = binding.includedBeginnerLegCoreD1W3.nextBtnTV
    ...
    private fun askPrefVisit(){
        ...
        if(workoutNumSet == "6"){
            editor = sharedPreferences.edit()
            editor.putString("Set", "7")
            editor.commit()
        }
        else if(workoutNumSet == "7"){
            editor = sharedPreferences.edit()
            editor.putString("Set", "8")
            editor.commit()

        }
        else if(workoutNumSet == "8"){
            editor = sharedPreferences.edit()
            editor.putString("Set", "9")
            editor.commit()
        }
        else{
        }
