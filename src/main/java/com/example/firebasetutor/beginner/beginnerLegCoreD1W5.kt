...
import com.example.firebasetutor.databinding.ActivityBeginnerLegCoreD1W5Binding

class beginnerLegCoreD1W5 : AppCompatActivity() {

    private lateinit var binding: ActivityBeginnerLegCoreD1W5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBeginnerLegCoreD1W5Binding.inflate(layoutInflater)
        setContentView(binding.root)

        workoutTV = binding.includedBeginnerLegCoreD1W5.workoutNameTV
        setValueText = binding.includedBeginnerLegCoreD1W5.setTV
        workoutAmountTV = binding.includedBeginnerLegCoreD1W5.workoutAmountTV
        ...
        Glide.with(this)
            ...
            .load(gif1)
            .fitCenter()
            .into(binding.includedBeginnerLegCoreD1W5.gifIV)


        initializeViews()


        val getWorkoutName = sharedPreferences.getString("workoutName5", "")
        val getRepCount = sharedPreferences.getString("repCount5", "")

        val a1 = binding.includedBeginnerLegCoreD1W5.workoutNameTV
        val a2 = binding.includedBeginnerLegCoreD1W5.workoutAmountTV
        ...
        if (isBeginnerSchedView == "Yes") {
            ...
            if (isWorkout == "LegCore") {
                ...
                when(beginnerLegCorePhase){
                    0, 1, 2, 3, 4, 5 ->{
                        when(workoutNumSet){
                            "12" -> gif1 = R.drawable.gif_wall_sit
                            "13" -> gif1 = R.drawable.gif_wall_sit
                            "14" -> gif1 = R.drawable.gif_wall_sit
            ...
            if (isWorkout == "LegCore") {
                ...
                when(intermediateLegCorePhase){
                    0, 1, 2, 3, 4, 5 ->{
                        when(workoutNumSet){
                            "12" -> gif1 = R.drawable.gif_jump_squat
                            "13" -> gif1 = R.drawable.gif_jump_squat
                            "14" -> gif1 = R.drawable.gif_jump_squat
    ...
    private fun initializeViews() {
        countdownTextView = binding.includedBeginnerLegCoreD1W5.timeCountdownTV
        workoutAmountTV = binding.includedBeginnerLegCoreD1W5.workoutAmountTV
        pauseButton = binding.includedBeginnerLegCoreD1W5.pauseBtnTV
        //nextButton = binding.includedBeginnerLegCoreD1W5.nextBtnTV
    ...
    private fun askPrefVisit(){
        ...
        if(workoutNumSet == "12"){
            editor = sharedPreferences.edit()
            editor.putString("Set", "13")
            editor.commit()
        }
        else if(workoutNumSet == "13"){
            editor = sharedPreferences.edit()
            editor.putString("Set", "14")
            editor.commit()

        }
        else if(workoutNumSet == "14"){
            editor = sharedPreferences.edit()
            editor.putString("Set", "15")
            editor.commit()
        }
        else{
        }
