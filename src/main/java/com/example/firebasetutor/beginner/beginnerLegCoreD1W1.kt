...
import com.example.firebasetutor.databinding.ActivityBeginnerLegCoreD1W1Binding

class beginnerLegCoreD1W1 : AppCompatActivity() {

    private lateinit var binding: ActivityBeginnerLegCoreD1W1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBeginnerLegCoreD1W1Binding.inflate(layoutInflater)
        setContentView(binding.root)

        workoutTV = binding.includedBeginnerLegCoreD1W1.workoutNameTV
        setValueText = binding.includedBeginnerLegCoreD1W1.setTV
        workoutAmountTV = binding.includedBeginnerLegCoreD1W1.workoutAmountTV
        ...
        Glide.with(getApplicationContext())
            ...
            .load(gif1)
            .fitCenter()
            .into(binding.includedBeginnerLegCoreD1W1.gifIV)
        ...
        val a1 = binding.includedBeginnerLegCoreD1W1.workoutNameTV
        val a2 = binding.includedBeginnerLegCoreD1W1.workoutAmountTV
        ...
        if (isBeginnerSchedView == "Yes") {
            ...
            if (isWorkout == "LegCore") {
                ...
                when(beginnerLegCorePhase){
                    0, 1, 2, 3, 4, 5 -> {
                        when(workoutNumSet){
                            "" -> gif1 = R.drawable.gif_plank
                            "1" -> gif1 = R.drawable.gif_plank
                            "2" -> gif1 = R.drawable.gif_plank
                        }
                    }
                    else -> {
                        when(workoutNumSet){
            ...
            if (isWorkout == "LegCore") {
                ...
                when(intermediateLegCorePhase){
                    0, 1, 2, 3, 4, 5 ->{
                        when(workoutNumSet){
                            "" -> gif1 = R.drawable.gif_hollow_body_hold
                            "1" -> gif1 = R.drawable.gif_hollow_body_hold
                            "2" -> gif1 = R.drawable.gif_hollow_body_hold
                        }
                    }
                    else ->{
                        when(workoutNumSet){
    ...
    private fun initializeViews() {
        countdownTextView = binding.includedBeginnerLegCoreD1W1.timeCountdownTV
        workoutAmountTV = binding.includedBeginnerLegCoreD1W1.workoutAmountTV
        pauseButton = binding.includedBeginnerLegCoreD1W1.pauseBtnTV
        //nextButton = binding.includedBeginnerLegCoreD1W1.nextBtnTV
